...
- 对于个人来说，2025的面试题开始遇到允许AI来实现，与自己的回答来作比较了。考察个人的思考和对AI的控制。
- “AI不仅改变了我们的工作方式，也在改变我们对"优秀工程师"的定义。沟通能力、品味、对工具的掌控力，这些过去相对软性的能力，现在都成了核心竞争力。”

### 软件界面如何设计
[软件界面如何设计](https://www.ruanyifeng.com/blog/2025/11/weekly-issue-372.html)
作者认为很多程序员设计的界面，堆砌一堆功能，并举例Handbrake。造成入门，外行的心智负担。
联想到国内的App开屏首页密密麻麻的功能（吐槽）...给我感觉就是，心智负担小的设计便是，预设默认的简单模式后，再提供高级功能的模式，由开发者的功能堆砌的角度转向用户体验的设计角度。当然这是由产品定位决定的。

### [为什么你的下一个移动应用很可能是无头的](https://tuananh.net/2026/03/18/why-your-next-mobile-app-is-probably-headless/)

该文章核心观点是：**未来移动应用会走向「无头化」—— 前端界面与后端服务彻底解耦，用户无需打开独立 App，通过 AI 助手 / 系统 Agent 直接调用后端服务完成任务，App 的 “界面外壳” 不再是必需入口**。
高频强交互（社交、游戏、创作、重度工具），这类仍需要原生界面保障体验。

这轮AI出现，我想象中交互就是这样了，一些界面入口没必要存在了，后端服务交给Agent形式的调用。


### [用户体验法则](https://lawsofux.com/) 
用户体验法则是一组设计者在构建用户界面时可以参考的最佳实践。
...
```
思考:精益开发有其道理，这样开发的产品更贴近客户，更能第一时间满足客户需求，占据当前的市场；

但我认为最终的成果离不开团队整体的运作。最小的产品原型这个边界在哪里？把控不好很容易又过于详细；话事人没有把握住这个边界；客户最需要的东西反馈不到需求文档上；

私认为我们团队目前的产品推进问题在此，过早开发复杂繁琐的功能，不符合精益二字。
```
